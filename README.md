...
apps/api/
  ...
  src/modules/auth/              OAuth Discord, sesiones y autorización viewer/admin
...
packages/database/
  src/schema.ts                  Las 19 tablas del modelo (incluye sesiones y estados OAuth)
