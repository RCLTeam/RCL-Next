...
CREATE TABLE "rounds" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "rounds_id_id_season_division_pk" PRIMARY KEY("id","id_season_division")
);
--> statement-breakpoint
...
CREATE TABLE "team_memberships" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "team_memberships_team_id_discord_user_id_pk" PRIMARY KEY("team_id","discord_user_id"),
...
--> statement-breakpoint
ALTER TABLE "audit_logs" ADD CONSTRAINT "audit_logs_actor_discord_user_id_discord_users_discord_id_fk" FOREIGN KEY ("actor_discord_user_id") REFERENCES "public"."discord_users"("discord_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "match_games" ADD CONSTRAINT "match_games_matches_id_matches_id_fk" FOREIGN KEY ("matches_id") REFERENCES "public"."matches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "match_games" ADD CONSTRAINT "match_games_blue_team_id_teams_id_fk" FOREIGN KEY ("blue_team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "match_games" ADD CONSTRAINT "match_games_red_team_id_teams_id_fk" FOREIGN KEY ("red_team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "match_games" ADD CONSTRAINT "match_games_winner_team_id_teams_id_fk" FOREIGN KEY ("winner_team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "matches" ADD CONSTRAINT "matches_id_season_division_seasons_divisions_id_fk" FOREIGN KEY ("id_season_division") REFERENCES "public"."seasons_divisions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "pickem_bonus_answers" ADD CONSTRAINT "pickem_bonus_answers_discord_user_id_discord_users_discord_id_fk" FOREIGN KEY ("discord_user_id") REFERENCES "public"."discord_users"("discord_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "pickem_bonus_questions" ADD CONSTRAINT "pickem_bonus_questions_season_name_seasons_name_fk" FOREIGN KEY ("season_name") REFERENCES "public"."seasons"("name") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pickem_predictions" ADD CONSTRAINT "pickem_predictions_discord_user_id_discord_users_discord_id_fk" FOREIGN KEY ("discord_user_id") REFERENCES "public"."discord_users"("discord_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "players" ADD CONSTRAINT "players_discord_user_id_discord_users_discord_id_fk" FOREIGN KEY ("discord_user_id") REFERENCES "public"."discord_users"("discord_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "rounds" ADD CONSTRAINT "rounds_id_season_division_seasons_divisions_id_fk" FOREIGN KEY ("id_season_division") REFERENCES "public"."seasons_divisions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "seasons_divisions" ADD CONSTRAINT "seasons_divisions_season_name_seasons_name_fk" FOREIGN KEY ("season_name") REFERENCES "public"."seasons"("name") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "seasons_divisions" ADD CONSTRAINT "seasons_divisions_division_name_divisions_name_fk" FOREIGN KEY ("division_name") REFERENCES "public"."divisions"("name") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team_memberships" ADD CONSTRAINT "team_memberships_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team_memberships" ADD CONSTRAINT "team_memberships_discord_user_id_discord_users_discord_id_fk" FOREIGN KEY ("discord_user_id") REFERENCES "public"."discord_users"("discord_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "teams" ADD CONSTRAINT "teams_season_division_id_seasons_divisions_id_fk" FOREIGN KEY ("season_division_id") REFERENCES "public"."seasons_divisions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
