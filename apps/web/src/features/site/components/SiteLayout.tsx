    ...
    <div className="rcl-site">
      ...
      <header className="site-header">
        <div className="nav-top">
          <SiteLink className="brand" href="/" aria-label="Rebel Crown Legacy · Inicio">
            <img src="/brand/rcl-logo.png" alt="RCL" width="92" height="38" />
          </SiteLink>
        ...
        <div className={`nav-bottom ${menuOpen ? 'is-open' : ''}`}>
          ...
          <div className="nav-tools">
            {leagueSwitch}
            <SiteLink className="admin-link" href="/admin/rofl/upload">
              ROFL Upload <span aria-hidden="true">↗</span>
            </SiteLink>
          </div>
        </div>
      </header>
      ...
      <footer className="site-footer">
        <div className="footer-top">
          <div>
            <img src="/brand/rcl-logo.png" alt="Rebel Crown Legacy" width="150" height="64" />
            <p className="meta">
